...
Our work focuses on simple products with no operating system, graphical interface, or application marketplace, from flashing fairy lights through domestic appliances to digital radios. Selecting this domain excludes simplistic design approaches which consider rich interface design as an adequate proxy for interaction design, while leaving product behaviour underspecified as a gap to be filled arbitrarily later in the engineering process.
...
Familiar techniques allow graphical artifacts or physical products to be represented and reflected upon. However, capturing the design of product \emph{firmware} on the page of a sketchbook presents problems, since it is both immaterial \cite{Ozenc} and processual \cite{Bratteteig}. Since it is immaterial there is no trivial two-dimensional projection of its code which a non-programmer can be expected to author or interpret. Since it is processual, by nature determined by circumstance and history, any static representations deliver only a partial view of the product behaviour. As a result, when attempting to design interactive systems through sketching, designers feel they have "not had enough feedback to know if this is the design they want” \cite{Ozenc}.

% =============================================================================
\section{Architecture versus Firmware Engineering}
% =============================================================================

Sketches and drawings perform other important functions in reflective design fields. They act as a record allowing designers and stakeholders to revisit the alternatives under consideration and facilitate sharing for collaboration and consensus \cite{VanDerLugt}. 
...
Wizard of Oz and Visual Programming
